 ...
 * Twitter/X embed
 */
function generateTwitterEmbed(tweetUrl: string): string {
 ...
 * TikTok embed
 */
function generateTikTokEmbed(videoUrl: string): string {
  return `<blockquote 
  class="tiktok-embed" 
  cite="${videoUrl}" 
  data-video-id="" 
 ...
 * Instagram embed
 */
function generateInstagramEmbed(postUrl: string): string {
  return `<blockquote 
 ...
 * Podcast audio embed
 */
function generatePodcastEmbed(audioUrl: string): string {
  // Check for Spotify
 ...
 */
function generateArticleEmbed(url: string, options?: ArticleEmbedOptions): string {
 ...
 */
function generateGenericEmbed(url: string): string {
 ...
 */
export function generateMarkdownEmbed(platform: Platform, idOrUrl: string): string {
  switch (platform) {
    case 'youtube':
