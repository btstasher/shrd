 ...
 */
export async function generateViaGateway(content, options = {}) {
...
async function callGateway(prompt) {
    ...
    if (!token) {
        throw new Error('OpenClaw gateway token not found. Set OPENCLAW_GATEWAY_TOKEN or ensure OpenClaw is running.');
    }
